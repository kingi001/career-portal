        ...
        <div class="bg-white rounded-lg shadow-2xl w-full max-w-xl transform transition-all duration-300 scale-95"
            ...
            <div class="flex justify-between items-center px-6 py-2 bg-indigo-600 text-white rounded-t-lg">
                <h2 class="text-lg font-semibold flex items-center gap-1">
                    <i class="fas fa-certificate text-xl mr-1"></i>
                    {{ __('Add Professional Qualification') }}
                </h2>
            ...
            <!-- Modal Form -->
            <form method="POST" action="{{ route('qualifications.store') }}" class="p-3 space-y-3">
                @csrf

                <p class="text-sm text-gray-700">
                    Please provide details of your professional qualifications, starting with the most recent.
                </p>
                ...
                <div class="mt-6 flex justify-end space-x-4">
                    ...
                    <button type="button" @click="open = false"
                        class="bg-gray-500 hover:bg-gray-700 text-white px-4 py-2 text-sm font-medium rounded-lg flex items-center gap-2 shadow-md hover:shadow-lg transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-gray-400">
                        <i class="fas fa-times"></i> {{ __('Cancel') }}
                    </button>

                    <!-- Save Button -->
                    <button type="submit"
                        class="bg-blue-600 hover:bg-blue-800 text-white px-4 py-2 text-sm font-medium rounded-lg flex items-center gap-2 shadow-md hover:shadow-lg transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-400">
