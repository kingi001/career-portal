        ...
        <div class="p-6 bg-white border border-gray-200 rounded-lg shadow-lg">
            ...
            <div class="mt-4" x-data="fileUpload()">
                            ...
                            <div class="border-2 border-dashed border-gray-400 rounded-md p-4 relative bg-white cursor-pointer"
                                ...
                                <template x-if="doc.file">
                                    <div class="flex flex-col gap-2 mt-2">
                                        ...
                                        <template x-if="doc.category === 'academic' && doc.certificateType">
                                            <p class="text-xs text-gray-700">
                                                Certificate Type: <span class="font-semibold" x-text="doc.certificateType"></span>
                                            </p>
                                        </template>
                                    </div>
                                </template>
                ...
                <div class="mt-4 flex gap-4">
                    <button @click="addDocument('academic')" class="px-4 py-2 text-sm font-semibold text-white bg-blue-600 rounded hover:bg-blue-700">
                        Add Academic Certificate
                    </button>
                    <button @click="addDocument('professional')" class="px-4 py-2 text-sm font-semibold text-white bg-green-600 rounded hover:bg-green-700">
                        Add Professional Certificate
                    </button>
                    <button @click="addDocument('membership')" class="px-4 py-2 text-sm font-semibold text-white bg-purple-600 rounded hover:bg-purple-700">
